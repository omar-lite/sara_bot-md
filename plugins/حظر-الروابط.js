...
export async function before(m, { isAdmin, isBotAdmin }) {
    ...
    if (chat.antiLink && isGroupLink && !isAdmin) {
        ...
        if (isBotAdmin && bot.restrict) {
            ...
            return m.reply('*[❗] لم يقم مالك البوت بتمكين حظر الروابط تواصل بالمطور لتفعيله*');
        }
    }
    return true;
}
